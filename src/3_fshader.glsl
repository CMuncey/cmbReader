...
void main()
{
	...
	// If only they didn't needlesly remove glTexEnv...
	...
	// Just the one texture combiner for now
	// Doing this all manually is way better than the old way
